<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("relatorio");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid relatorio");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: HumanTask.GrupoUser1
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[user1]]></div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">relatorio</label>
                            		<div class="div_checkbox">
                              		${relatorio}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="relatorio" type="text" class="textbox" id="relatorio" value="${relatorio}" />
                            		</div>
